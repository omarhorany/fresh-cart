    ...
    return (
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm flex flex-col m-3">
            ...
            <div className="flex items-center justify-between">
                <button onClick={() => addToCart(_id)} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-full">
                    Add to cart
                </button>
            </div>
        </div>
